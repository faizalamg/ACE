...
```python
# Z.ai GLM (default)
agent = ACELiteLLM()  # Uses openai/glm-4.6
...
See [examples/LMstudio/](../examples/LMstudio/) for local model setup guide.
...
- **[Integration Guide](INTEGRATION_GUIDE.md)** - Add ACE to existing agents (includes Enterprise Integration)
- **[Complete Guide](COMPLETE_GUIDE_TO_ACE.md)** - Deep dive into ACE concepts + Enterprise Features
- **[API Reference](API_REFERENCE.md)** - Complete API documentation including enterprise modules
...
**Enterprise Features:** Vector search, async retrieval, caching, horizontal scaling, multi-tenancy - see [Integration Guide: Enterprise Integration](INTEGRATION_GUIDE.md#enterprise-integration)
